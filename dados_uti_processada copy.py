...
# === 6. Calcular taxa de leitos de UTI por 10.000 habitantes ===
df_final["População estimada - pessoas [2024]"] = pd.to_numeric(df_final["População estimada - pessoas [2024]"], errors="coerce")
df_final["leitos_por_10000_hab"] = (df_final["UTI_TOTAL_EXIST"] / df_final["População estimada - pessoas [2024]"]) * 10000

# === 7. Definir meta de cobertura e classificar ===
meta_ideal = 2.0  # leitos por 10.000 habitantes
df_final["leitos_ideais"] = (df_final["População estimada - pessoas [2024]"] * meta_ideal) / 10000
df_final["deficit_leitos"] = df_final["leitos_ideais"] - df_final["UTI_TOTAL_EXIST"]
df_final["classificacao"] = df_final["leitos_por_10000_hab"].apply(
